...
def main():
    ...
    create_button(
        "Заполнить", lambda arg1=canvas_class, arg2=entry_start_point: fill(arg1, arg2), [1000, 675])

    create_button(
        "Заполнить с задержкой", lambda arg1=canvas_class, arg2=entry_start_point: fill(arg1, arg2, 1), [1000, 725])
